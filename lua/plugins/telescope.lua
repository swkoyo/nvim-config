return {
	...
	keys = {
		...
		{ "<leader>su", function() require("telescope.builtin").grep_string({ word_match = "-w"}) end, desc = "Word under cursor (root dir)" },
		{ "<leader>sU", function() require("telescope.builtin").grep_string({ cwd = false, word_match = "-w" }) end, desc = "Word under cursor (cwd)" },
		{ "<leader>sw", function() require("telescope.builtin").live_grep({ word_match = "-w" }) end, desc = "Word (root dir)" },
		{ "<leader>sW", function() require("telescope.builtin").live_grep({ cwd = false, word_match = "-w" }) end, desc = "Word (cwd)" },
		{ "<leader>sw", function() require("telescope.builtin").live_grep() end, mode = "v", desc = "Selection (root dir)" },
		{ "<leader>sW", function() require("telescope.builtin").live_grep({ cwd = false }) end, mode = "v", desc = "Selection (cwd)" },
